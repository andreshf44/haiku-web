...
export default async function CabanaPage({ params }: PageProps) {
    ...
    <div className="bg-[#f5eedf]">
      ...
      <section className="grid md:grid-cols-2 gap-8 p-10">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-2xl font-semibold text-[#134520] mb-2">Un espacio pensado para ti</h2>
          <p className="text-[#3c371f] leading-relaxed text-lg italic">{cabana.descripcion}</p>
        </div>
      </section>

      {/* Experiencias */}
      <section className="bg-[#134520] py-10 px-6 text-[#f5eedf]">
        <h3 className="text-xl font-semibold text-center mb-6">Disfruta también de:</h3>
